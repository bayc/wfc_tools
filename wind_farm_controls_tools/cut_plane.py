...
class _CutPlane():
    ...
    def __init__(self, flow_field, x1='x', x2='y', x3_value=None,resolution=100,x1_center=0.0,x2_center=0.0, D=None, invert_x1=False,
...
class HorPlane(_CutPlane): 
    ...
    def __init__(self, flow_field, z_value, resolution=100, x1_center=0.0,x2_center=0.0, D=None):
        ...
        # Set up call super
        super().__init__(flow_field, x1='x', x2='y', x3_value=z_value,resolution=resolution,x1_center=x1_center,x2_center=x2_center, D=D, invert_x1=False)
...
class CrossPlane(_CutPlane): 
    ...
    def __init__(self, flow_field, x_value, y_center, z_center, D, resolution=100, crop_y=None,crop_z=None,invert_x1=True):
        ...
        # Set up call super
        super().__init__(flow_field, x1='y', x2='z', x3_value=x_value,resolution=resolution,x1_center=y_center,x2_center=z_center, D=D, invert_x1=invert_x1, crop_x1 = crop_y, crop_x2=crop_z)
